...
public class TestTagsAssociateRequest {
  ...
  @Test
  public void testTagsAssociateRequestSerDeWithValues() throws JsonProcessingException {
  ...
  @Test
  public void testTagsAssociateRequestValidateValues() throws JsonProcessingException {
    TagsAssociateRequest validRequest =
        new TagsAssociateRequest(new TagValue[] {TagValue.of("data_domain", "finance")}, null);

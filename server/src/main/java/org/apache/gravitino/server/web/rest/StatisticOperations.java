...
public class StatisticOperations {
  ...
  @GET
  @Path("/catalogs/{catalog}/schemas/{schema}/tables/{table}/statistics")
  ...
  public Response updateTableStatistics(
    ...
    try {
      ...
      return Utils.doAs(
          ...
          () -> {
            ...
            for (Map.Entry<String, StatisticValue<?>> entry :
                request.getUpdateStatistics().entrySet()) {
      ...
      return ExceptionHandlers.handleStatisticException(
          ...
          StringUtils.join(request.getUpdateStatistics().keySet(), ","),
          table,
          e);
    }
  }

...
public interface SupportsRelationOperations {
  ...
  /**
   * Updates tag relations for a given entity by adding and removing tag-value assignments.
   *
   ...
   * @param tagsToAdd Tag values to associate with the source entity.
   * @param tagsToRemove Tag values to disassociate from the source entity.
